...
#from airflow.operators.python_operators import BashOperator
...
t2 = DockerOperator(
    ...
    network_mode="bridge",
    mounts=[
        Mount(source='/Users/Amit/VScodeProjects/dataeng_course/custom_postgres',
              target='/dbt', type='bind'),
        Mount(source='/home/amit/.dbt',
